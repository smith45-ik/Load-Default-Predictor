...
cb_person_default_on_file, cb_person_cred_hist_length): 
    ...
    # Creating a dataframe to pass into the predict function    
    df = pd.DataFrame([[person_age, person_income, person_home_ownership, person_emp_length, 
                        loan_intent, loan_grade, loan_amnt, loan_int_rate, loan_percent_income, 
                        cb_person_default_on_file, cb_person_cred_hist_length]], 
...
with col2:
    ...
    loan_percent_income = st.number_input('Percentage of Loan to Income', 
                                        min_value=0.0, max_value=100.0, value=0.01)
...
if st.button('Predict Default'):
    loan_status = predict(person_age, person_income, person_home_ownership, 
